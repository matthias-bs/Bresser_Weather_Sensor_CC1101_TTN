function ttn_decoder(bytes) {
  ...
  return decode(
    bytes,
    [uint32,       uint8,        temperature, uint8,      rawfloat,             rawfloat,              rawfloat,
    rawfloat  ],
    [ 'sensor_id', 'battery_ok', 'temp_c',    'humidity',  'wind_gust_meter_sec', 'wind_avg_meter_sec', 'wind_direction_deg',
    'rain_mm' ]
  );
}
